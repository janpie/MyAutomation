...
public class TC3_CreateAccountLatvia extends TestBase{
	...
	public void createAccountNorway()  {
		...
		String latviaMail = mg.generateMailLatvia();
		capo.registerCredentials(latviaMail, "Assa123//", "Fname" , "Lname", 4);//mail is random // Regions: 0-Norway, 1-Denmark, 2-Sweden, 3-Lithuania, 4-Latvia, 5-Estonia, 6-Poland //
		capo.allowExtra();
	}
	@Test(priority = 2)
