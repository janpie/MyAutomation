...
public class TC3_CreateAccountPoland extends TestBase{
	...
	public void createAccountNorway()  {
		...
		String polandMail = mg.generateMailPoland();
		capo.registerCredentials(polandMail, "Assa123//", "Fname" , "Lname", 6);//mail is random // Regions: 0-Norway, 1-Denmark, 2-Sweden, 3-Lithuania, 4-Latvia, 5-Estonia, 6-Poland //
		capo.allowExtra();
	}
	@Test(priority = 2)
