...
public class TC3_CreateAccountNorway extends TestBase{
	...
	public void createAccountNorway()  {
		...
		String norwayMail = mg.generateMailNorway();
		capo.registerCredentials(norwayMail, "Assa123//", "Fname" , "Lname", 0);//mail is random // Regions: 0-Norway, 1-Denmark, 2-Sweden, 3-Lithuania, 4-Latvia, 5-Estonia, 6-Poland //
		capo.allowExtra();
	}
	@Test(priority = 2)
