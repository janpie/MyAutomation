...
public class TC3_CreateAccountEstonia extends TestBase{
	...
	public void createAccountNorway()  {
		...
		String estoniaMail = mg.generateMailEstonia();
		capo.registerCredentials(estoniaMail, "Assa123//", "Fname" , "Lname", 5);//mail is random // Regions: 0-Norway, 1-Denmark, 2-Sweden, 3-Lithuania, 4-Latvia, 5-Estonia, 6-Poland //
		capo.allowExtra();
	}
	@Test(priority = 2)
