...
public class TC4_CreateAccountSweden extends TestBase{
	...
	@Test(priority=1)
	public void createAccountSweden()  {
		...
		String swedenMail = mg.generateMailSweden();
		capo.registerCredentials(swedenMail, "Assa123//", "Fname" , "Lname", 2);//mail is random // Regions: 0-Norway, 1-Denmark, 2-Sweden, 3-Lithuania, 4-Latvia, 5-Estonia, 6-Poland //
		capo.allowExtra();
	}
	...
	@Test(priority = 4)
	public void addRegularCardSweden() {
